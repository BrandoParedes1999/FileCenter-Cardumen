...
<style>
.view-btn.active         { color: #22c55e; }
.btn-nuevo               { background: linear-gradient(135deg, #16a34a, #22c55e); box-shadow: 0 4px 14px rgba(22,163,74,0.35); }
.btn-nuevo:hover         { box-shadow: 0 6px 20px rgba(22,163,74,0.45); }
.fc-topbar-avatar        { background: linear-gradient(135deg, #16a34a, #22c55e); }
.fc-topbar-role          { color: #16a34a; }
.area-logo-box           { box-shadow: 0 2px 8px rgba(22,163,74,0.12); }
.breadcrumb a:hover      { color: #16a34a; }
.breadcrumb-current      { color: #16a34a; }
.carpeta-item.active     { background: #f0fdf4; border-left-color: #22c55e; }
.carpeta-item.active .carpeta-item-icon { color: #22c55e; }
.carpeta-item.active .carpeta-item-name { color: #16a34a; }
.carpeta-item-count      { color: #22c55e; background: rgba(34,197,94,0.1); }
.area-banner             { background: linear-gradient(135deg, #16a34a 0%, #15803d 50%, #22c55e 100%); }
.carpeta-card:hover      { box-shadow: 0 8px 24px rgba(22,163,74,0.12); border-color: #bbf7d0; }
.carpeta-card-icon       { background: rgba(34,197,94,0.08); }
.carpeta-action-btn.edit       { color: #22c55e; }
.carpeta-action-btn.edit:hover { background: rgba(34,197,94,0.1); }
</style>
    ...
    <div class="fc-main">
        ...
        <header class="fc-topbar">
            <div class="fc-topbar-left">
                ...
                <div class="fc-topbar-sub">4 carpetas · 24 archivos</div>
            </div>
        ...
        <div class="fc-body">
            <div class="carpetas-sidebar">
                <div class="carpetas-sidebar-header">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-current">OMC</span>
                    </div>
                </div>
            ...
            <div class="fc-content">
                <div class="area-banner">
                    <p class="area-banner-desc">Documentación de la empresa OMC del corporativo Cardumen. Agencia naviera y gestión de trámites portuarios.</p>
                    <div class="area-banner-stats">
                        <div><div class="area-banner-stat-num">4</div><div class="area-banner-stat-lbl">Carpetas</div></div>
                        <div><div class="area-banner-stat-num">24</div><div class="area-banner-stat-lbl">Archivos</div></div>
                ...
                <div class="carpetas-grid" id="carpetasGrid">
                    ...
                    <div class="carpeta-card">
                        <div class="carpeta-card-icon"><svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg></div>
