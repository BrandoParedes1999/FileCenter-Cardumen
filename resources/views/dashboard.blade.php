        ...
        <div>
            ...
            <div class="fc-content">
                ...
                <div class="fc-content-main">
                    ...
                    {{-- ── Gráficas Chart.js ── --}}
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-top:20px" class="charts-grid">
                        ...
                        <div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:20px">
                            <div style="display:flex;align-items:center;gap:7px;margin-bottom:14px">
                                ...
                                <span style="font-size:13px;font-weight:700;color:#1e293b">Archivos subidos (6 meses)</span>
                            </div>
                            <canvas id="chartUploads" height="160"></canvas>
                        </div>
                        ...
                        <div style="background:#fff;border:1px solid #e2e8f0;border-radius:14px;padding:20px">
                            <div style="display:flex;align-items:center;gap:7px;margin-bottom:14px">
                                ...
                                <span style="font-size:13px;font-weight:700;color:#1e293b">Actividad por tipo</span>
                            </div>
                    ...
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        // Chart 1: Uploads por mes
                        new Chart(document.getElementById('chartUploads'), {
                            type: 'bar',
                            data: {
                                labels: @json($chartMeses),
                                datasets: [{
                                    label: 'Archivos subidos',
                                    data: @json($chartUploads),
                        ...
                        // Chart 2: Actividad por tipo
                        const actColors = ['#6366f1','#0ea5e9','#f59e0b','#10b981','#ef4444','#a78bfa'];
                        new Chart(document.getElementById('chartActivity'), {
                            type: 'doughnut',
                            data: {
                                labels: @json($chartActTypes),
                                datasets: [{
                                    data: @json($chartActCounts),
