            ...
            <div class="fc-content-main">
                ...
                <div class="fc-stats">
                    ...
                    <div class="fc-stat">
                        ...
                        <div class="fc-stat-arrow">↗</div>
                        <div class="fc-stat-num">130</div>
                        <div class="fc-stat-label">Total archivos</div>
                        <div class="fc-stat-trend pos">+23 esta semana</div>
                    </div>
                    ...
                    <div class="fc-stat">
                        ...
                        <div class="fc-stat-arrow">↗</div>
                        <div class="fc-stat-num">23</div>
                        <div class="fc-stat-label">Total carpetas</div>
                        <div class="fc-stat-trend neutral">23 carpetas</div>
                    </div>
                ...
                <div class="fc-chart-box">
                    ...
                    <div style="display:flex;align-items:flex-end;gap:4px;height:120px">
                        ...
                        <div style="display:flex;flex-direction:column;justify-content:space-between;height:110px;padding-right:10px">
                            <span style="font-size:10px;color:#475569">32</span>
                            <span style="font-size:10px;color:#475569">24</span>
                            <span style="font-size:10px;color:#475569">16</span>
                            <span style="font-size:10px;color:#475569">8</span>
                        ...
                        <div style="flex:1;display:flex;align-items:flex-end;gap:14px;height:110px">
                            ...
                            <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:5px">
                                <div style="width:100%;background:linear-gradient(to top,#4338ca,#6366f1);border-radius:5px 5px 0 0;height:65%"></div>
                                <span style="font-size:11px;color:#475569">Cardumen</span>
                            </div>

                            <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:5px">
                                <div style="width:100%;background:linear-gradient(to top,#4338ca,#6366f1);border-radius:5px 5px 0 0;height:75%"></div>
                                <span style="font-size:11px;color:#475569">OMC</span>
                            </div>

                            <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:5px">
                                <div style="width:100%;background:linear-gradient(to top,#4338ca,#6366f1);border-radius:5px 5px 0 0;height:85%"></div>
                                <span style="font-size:11px;color:#475569">Seaward</span>
                            </div>

                            <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:5px">
                                <div style="width:100%;background:linear-gradient(to top,#4338ca,#6366f1);border-radius:5px 5px 0 0;height:97%"></div>
                                <span style="font-size:11px;color:#475569">Seatools</span>
                            </div>

                            <div style="flex:1;display:flex;flex-direction:column;align-items:center;gap:5px">
                                <div style="width:100%;background:linear-gradient(to top,#4338ca,#6366f1);border-radius:5px 5px 0 0;height:72%"></div>
                                <span style="font-size:11px;color:#475569">TWS</span>
                            </div>
                ...
                <div>
                    ...
                    <div class="fc-areas-grid">
                        ...
                        <a href="#" class="fc-area-card">
                            <div style="display:flex;align-items:center;gap:11px">
                                <div class="fc-area-dot" style="background:#7c3aed"></div>
                                <div>
                                    <div class="fc-area-name">Cardumen</div>
                                    <div class="fc-area-meta">21 archivos · 15 miembros</div>
                                </div>
                            </div>
                        ...
                        <a href="#" class="fc-area-card">
                            <div style="display:flex;align-items:center;gap:11px">
                                <div class="fc-area-dot" style="background:#06b6d4"></div>
                                <div>
                                    <div class="fc-area-name">OMC</div>
                                    <div class="fc-area-meta">24 archivos · 6 miembros</div>
                                </div>
                            </div>
                            <div class="fc-area-chevron">›</div>
                        </a>
                        ...
                        <a href="#" class="fc-area-card">
                            <div style="display:flex;align-items:center;gap:11px">
                                <div class="fc-area-dot" style="background:#22c55e"></div>
                                <div>
                                    <div class="fc-area-name">Seaward</div>
                                    <div class="fc-area-meta">28 archivos · 6 miembros</div>
                                </div>
                            </div>
                            <div class="fc-area-chevron">›</div>
                        </a>
                        ...
                        <a href="#" class="fc-area-card">
                            <div style="display:flex;align-items:center;gap:11px">
                                <div class="fc-area-dot" style="background:#22c55e"></div>
                                <div>
                                    <div class="fc-area-name">Seatools</div>
                                    <div class="fc-area-meta">31 archivos · 6 miembros</div>
                                </div>
                            </div>
                            <div class="fc-area-chevron">›</div>
                        </a>
            ...
            <div class="fc-content-side">
                ...
                <div class="fc-activity-card">
                    ...
                    <div class="fc-act-item">
                        <div class="fc-act-icon bg-up">
                            <svg width="13" height="13" viewBox="0 0 24 24" class="icon-up">
                                <path d="M9 16h6v-6h4l-7-7-7 7h4zm-4 2h14v2H5z"/>
                            </svg>
                        </div>
                        <div style="flex:1;min-width:0">
                            <div class="fc-act-name"><strong>Roberto Silva</strong> subió</div>
                            <div class="fc-act-file">Plan_Emergencias_2026.pdf</div>
                            <div class="fc-act-time">hace 13d</div>
                        </div>
                    </div>
                    ...
                    <div class="fc-act-item">
                        ...
                        <div style="flex:1;min-width:0">
                            <div class="fc-act-name"><strong>Patricia Méndez</strong> subió</div>
                            <div class="fc-act-file">Capacitacion_Personal.pdf</div>
                            <div class="fc-act-time">hace 13d</div>
                        </div>
                    </div>
                    ...
                    <div class="fc-act-item">
                        ...
                        <div style="flex:1;min-width:0">
                            <div class="fc-act-name"><strong>Carlos Torres</strong> subió</div>
                            <div class="fc-act-file">Auditoria_Interna.pdf</div>
                            <div class="fc-act-time">hace 13d</div>
                        </div>
                    </div>
                    ...
                    <div class="fc-act-item">
                        ...
                        <div style="flex:1;min-width:0">
                            <div class="fc-act-name"><strong>Roberto Silva</strong> subió</div>
                            <div class="fc-act-file">Inspeccion_Equipos.pdf</div>
                            <div class="fc-act-time">hace 13d</div>
                        </div>
                    </div>
                    ...
                    {{-- ── Descarga ── --}}
                    <div class="fc-act-item">
                        <div class="fc-act-icon bg-down">
                            <svg width="13" height="13" viewBox="0 0 24 24" class="icon-down">
                                <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/>
                            </svg>
                        </div>
                        <div style="flex:1;min-width:0">
                            <div class="fc-act-name"><strong>Diego Morales</strong> descargó</div>
                            <div class="fc-act-file">Manual_Operaciones_Seawa...</div>
                            <div class="fc-act-time">hace 14d</div>
                        </div>
                    </div>
                    ...
                    <div class="fc-act-item">
                        ...
                        <div style="flex:1;min-width:0">
                            <div class="fc-act-name"><strong>Patricia Méndez</strong> subió</div>
                            <div class="fc-act-file">Auditoria_Operacional.pdf</div>
                            <div class="fc-act-time">hace 14d</div>
                        </div>
                    </div>
                    ...
                    {{-- ── Carpeta creada ── --}}
                    <div class="fc-act-item">
                        <div class="fc-act-icon bg-plus">
                            <svg width="13" height="13" viewBox="0 0 24 24" class="icon-plus">
                                <path d="M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-2 10h-4v4h-2v-4H7v-2h4V7h2v4h4v2z"/>
                            </svg>
                        </div>
                        <div style="flex:1;min-width:0">
                            <div class="fc-act-name"><strong>Roberto Silva</strong> creó carpeta</div>
                            <div class="fc-act-file">Operaciones - TWS</div>
                            <div class="fc-act-time">hace 15d</div>
                        </div>
                    </div>

                </div>{{-- /fc-activity-card --}}

                {{-- Usuarios por Rol es solo la targeta pero lo puedes hacer funcionar --}} 
                <div class="fc-roles-card">
                    <div class="fc-roles-title">Usuarios por Rol</div>

                    <div class="fc-role-row">
                        <div class="fc-role-name">Admin</div>
                        <div class="fc-role-bar-bg">
                            <div class="fc-role-bar" style="width:30%;background:#7c3aed"></div>
                        </div>
                        <div class="fc-role-count">4</div>
                    </div>

                    <div class="fc-role-row">
                        <div class="fc-role-name">Editor</div>
                        <div class="fc-role-bar-bg">
                            <div class="fc-role-bar" style="width:55%;background:#4338ca"></div>
                        </div>
                        <div class="fc-role-count">7</div>
                    </div>

                    <div class="fc-role-row">
                        <div class="fc-role-name">Visor</div>
                        <div class="fc-role-bar-bg">
                            <div class="fc-role-bar" style="width:25%;background:#06b6d4"></div>
                        </div>
                        <div class="fc-role-count">4</div>
                    </div>
