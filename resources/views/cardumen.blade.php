...
<style>
.view-btn.active         { color: #7c3aed; }
.btn-nuevo               { background: linear-gradient(135deg, #7c3aed, #4f46e5); box-shadow: 0 4px 14px rgba(124,58,237,0.35); }
.btn-nuevo:hover         { box-shadow: 0 6px 20px rgba(124,58,237,0.45); }
.fc-topbar-avatar        { background: linear-gradient(135deg, #7c3aed, #4f46e5); }
.fc-topbar-role          { color: #7c3aed; }
.area-logo-box           { box-shadow: 0 2px 8px rgba(124,58,237,0.12); }
.breadcrumb a:hover      { color: #7c3aed; }
.breadcrumb-current      { color: #7c3aed; }
.carpeta-item.active     { background: #f5f3ff; border-left-color: #7c3aed; }
.carpeta-item.active .carpeta-item-icon { color: #7c3aed; }
.carpeta-item.active .carpeta-item-name { color: #6d28d9; }
.carpeta-item-count      { color: #7c3aed; background: rgba(124,58,237,0.1); }
.area-banner             { background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 50%, #9333ea 100%); }
.carpeta-card:hover      { box-shadow: 0 8px 24px rgba(124,58,237,0.12); border-color: #ddd6fe; }
.carpeta-card-icon       { background: rgba(124,58,237,0.08); }
.carpeta-action-btn.edit       { color: #7c3aed; }
.carpeta-action-btn.edit:hover { background: rgba(124,58,237,0.1); }
</style>
            ...
            <div class="fc-topbar-left">
                <div class="fc-topbar-title" style="display:flex;align-items:center;gap:10px;">
                    <div class="area-logo-box">
                        <img src="{{ asset('images/logo.png') }}" alt="Cardumen">
                    </div>
                    Cardumen
                </div>
                <div class="fc-topbar-sub">7 carpetas · 21 archivos</div>
            </div>
        ...
        <div class="fc-body">
            <div class="carpetas-sidebar">
                <div class="carpetas-sidebar-header">
                    <div class="breadcrumb">
                        ...
                        <span class="breadcrumb-current">Cardumen</span>
                    </div>
                </div>
                <div class="carpetas-label">Carpetas</div>
                @foreach([
                    ['Recursos Humanos', 4],
                    ['SG (Sistemas de Gestión)', 3],
                    ['Controller', 3],
                    ['Rec (Recepción/Recursos)', 3],
                    ['Finanzas', 3],
                    ['T.I. (Tecnología de Infor...)', 3],
                    ['Compras', 2],
                ] as $i => $c)
            ...
            <div class="fc-content">
                <div class="area-banner">
                    <p class="area-banner-desc">Área corporativa del Grupo Cardumen. Documentación central compartida con todas las empresas.</p>
                    <div class="area-banner-stats">
                        <div><div class="area-banner-stat-num">7</div><div class="area-banner-stat-lbl">Carpetas</div></div>
                        <div><div class="area-banner-stat-num">21</div><div class="area-banner-stat-lbl">Archivos</div></div>
                        <div><div class="area-banner-stat-num">15</div><div class="area-banner-stat-lbl">Miembros</div></div>
                    </div>
                </div>
                ...
                <div class="carpetas-grid" id="carpetasGrid">
                    @foreach([
                        ...
                        ['Rec (Recepción/Recursos)', 3],
                        ['Finanzas', 3],
                        ['T.I. (Tecnología de Información)', 3],
                        ['Compras', 2],
                    ] as $c)
                    <div class="carpeta-card">
                        <div class="carpeta-card-icon">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#7c3aed" stroke-width="2"><path d="M22 19a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h5l2 3h9a2 2 0 012 2z"/></svg>
                        </div>
